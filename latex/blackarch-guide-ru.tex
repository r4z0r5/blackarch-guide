...
\section{Overview}
Руководство Пользователя BlackArch Linux разделено на несколько частей:
\begin{itemize}
\item Введение - Включает в себя общие сведения о проекте и вспомогательную информацию о нём.
\item Руководство Пользователя - Включает в себя всё, что необходимо знать Пользователю для эффективного использования BlackArch
\item Руководство Разработчика - Включает в себя всё, что необходимо знать разработчику для внесения собственного вклада в разработку BlackArch
\item Руководство по инструментарию - Углубленное описание включенных в дистрибутив инструментов с примерами применения (WIP)
\end{itemize}
